...
/* METADATA
{
    ...
    "env": [
        ...
        { "name": "QQBOT_PRO_GROUP_MEMBER_BINDINGS", "description": { "zh": "群成员身份绑定 JSON 数组（G7）：[{memberOpenid, groupOpenid?, title}]", "en": "Group member bindings JSON array (G7): [{memberOpenid, groupOpenid?, title}]" }, "required": false },
    ...
    "tools": [
        {
            ...
            "parameters": [
                ...
                { "name": "group_member_bindings", "description": { "zh": "群成员身份绑定（G7）：JSON 数组 [{memberOpenid, groupOpenid?, title}]，如 [{\"memberOpenid\":\"CC9F...\",\"title\":\"初尘\"}]；上下文中该成员显示为 title。", "en": "Group member identity bindings (G7): JSON array [{memberOpenid, groupOpenid?, title}]." }, "type": "string", "required": false },
