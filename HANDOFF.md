...
> 更新时间：2026-08-16 17:50
> 状态：v0.3.0（合并 qqbot-bridge-pro v1.0.0 完整桥接能力）；G0/G1/G2/G4/G7最小版/G3 replyTo/G5 落盘验证/**G6 设置 UI（2026-08-16 完成）**均已完成；根目录 README/ARCHITECTURE/STATUS 已于 2026-08-12 重建（旧版有 .backup_20260812_1913 备份），2026-08-13/08-14/08-16 持续补「规划 vs 已实现」诚实标注（STATUS §6 / ARCHITECTURE §11 / README Roadmap）。**下一步主线：可靠性 Sprint**（事务幂等 / token 缓存 / 错误码结构化）。
