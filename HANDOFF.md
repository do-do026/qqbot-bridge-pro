...
> 状态：v0.3.0（合并 qqbot-bridge-pro v1.0.0 完整桥接能力）；G0/G1/G2/G4/G7最小版已完成，**G3 replyTo 代码完成（2026-08-12，20/20 测试通过），待烧录 + 真机验证**；根目录 README/ARCHITECTURE/STATUS 已于 2026-08-12 重建（旧版有 .backup_20260812_1913 备份）
